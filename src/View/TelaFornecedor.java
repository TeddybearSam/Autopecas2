    ...
    private void BtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtSalvarActionPerformed
        ...
        if(TxCnpjF.getValue()==null || TipodeViaFor.getSelectedItem().equals("Selecione") || TxComplementoFor.getText().length()==0 || TxCelFor.getValue()==null || TxBairro.getText().length()==0 || ComboEstado.getSelectedItem().equals("Selecione")|| TxEstadualF.getText().length()==0|| TxCep.getValue()==null || TxCidade.getText().length()==0 || TxEmail.getText().length()==0 || TxEndereco.getText().length()==0 || TxRazaoSocial.getText().length()==0|| TxTelefone.getValue()==null)   {
            JOptionPane.showMessageDialog(null, "Preencha todos os campos!");
              ...
              For.setID(Integer.valueOf(TxIdFornecedor.getText()));
              For.setCNPJ(TxCnpjF.getText());
              ...
              For.setEstado((TxEstadualF.getText()));
              For.setCEP((TxCep.getText()));
              For.setTelefone(String.valueOf(TxTelefone.getValue()));
              For.setInscricaoEstadual((TxEstadualF.getText()));
              For.setEmail((TxEmail.getText()));
              For.setTipo_via(String.valueOf(TipodeViaFor.getSelectedItem()));
